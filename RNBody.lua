...
self.body:destroy()
--here should be destroyed the RNSprite but we can't at the moment.
--we should know the RNSprite parent scene and remove RNSprite's prop from layer
self.sprite:setLocation(1000,1000)
