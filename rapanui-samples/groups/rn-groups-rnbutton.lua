...
text = RNFactory.createText("Touch on buttons", { size = 18, top = 400, left = 5, width = 250, height = 50 })

nextText = "Click to move Down"

button = RNFactory.createButton("images/button-plain.png", { text = nextText, imageOver = "images/button-over.png", top = 20, left = 10, size = 16, width = 200, height = 50 })
--button.x = 10


button2 = RNFactory.createButton("images/button-plain.png", { text = "Button 2", imageOver = "images/button-over.png", top = 90, left = 10, size = 16, width = 200, height = 50 })
--button2.x = 10
--button2.y = 96
