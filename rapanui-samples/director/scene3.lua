...
function onCreate()
    ...
    local tile1a = RNFactory.createImage("images/tile3.png", { parentGroup = sceneGroup }); tile1a.x = 100; tile1a.y = 340;
    local tile1b = RNFactory.createImage("images/tile3.png", { parentGroup = sceneGroup }); tile1b.x = 100; tile1b.y = 240;
    local tile1c = RNFactory.createImage("images/tile3.png", { parentGroup = sceneGroup }); tile1c.x = 260; tile1c.y = 140;
