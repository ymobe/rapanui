...
function onCreate()
	...
	background = RNFactory.createImage("images/background-purple.png");background.x=160;background.y=240;
	tile1a = RNFactory.createImage("images/tile1.png");tile1a.x=160;tile1a.y=240;
	tile1b = RNFactory.createImage("images/tile1.png");tile1b.x=100;tile1b.y=240;
	tile1c = RNFactory.createImage("images/tile1.png");tile1c.x=260;tile1c.y=240;
