...
function aScene.onCreate()
    ...
    local text1 = RNFactory.createText("This is the scene four.", { size = 8, top = 400, left = 50, width = 200, height = 500 })
...
function button1Up(event)
    ...
    director:showScene("rapanui-samples/menu/scene1m", "slidetotop")
end
