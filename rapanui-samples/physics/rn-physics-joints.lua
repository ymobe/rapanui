...
j7 = RNPhysics.createJoint("pulley", box, triangle, 200, 50, 10, 50, box:getX(), box:getY(), triangle:getX(), triangle:getY(), 1)
...
--[[
	...
	Mouse joint and gear joint under developement.
	

	Check other samples for joint list acces tutorial.
